...
import { EmptyJobsIllustration } from '../components/EmptyJobsIllustration';
  ...
  return (
    <div className="dash">
      <section className="dash-section" aria-labelledby="top-matches-heading">
        ...
        {topMatches.length === 0 ? (
          <EmptyJobsIllustration message="No matches yet. Start the co-pilot on Naukri to fill this row." />
        ) : (
